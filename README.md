...
| <a name="input_inspector_ec2_exclusion"></a> [inspector\_ec2\_exclusion](#input\_inspector\_ec2\_exclusion) | When true, tag the instance with InspectorEc2Exclusion=true to exclude it from AWS Inspector EC2 scanning. | `bool` | `false` | no |
